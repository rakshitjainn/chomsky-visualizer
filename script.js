            ...
            switch(lbaState) {
                ...
                case 'q1_seek_B':
                    if(char === 'a' || char === 'Y') {
                        ...
                        lbaState = 'Trap';
                        action = `CRASH: Hit '${char}' without finding 'b'. (Hit boundary/wrong char before finding required character)`;
                    } else {
                        lbaState = 'Trap';
                        action = `CRASH: Unexpected '${char}'`;
                    }
                ...
                case 'q2_seek_C':
                    if(char === 'b' || char === 'Z') {
                        ...
                        lbaState = 'Trap';
                        action = `CRASH: Hit '${char}' without finding 'c'. (Hit boundary/wrong char before finding required character)`;
                    } else {
                        lbaState = 'Trap';
                        action = `CRASH: Unexpected '${char}'`;
                    }
